...
export const createClient = async (req, res, next) => {
    try {
        ...
        if (!username || !phone || !email) return next(createError(400, 'Username and Phone are required; Email needs to be provided'))
...
export const createEmployee = async (req, res, next) => {
    try {
        ...
        if (!username || !phone || !password) return next(createError(400, 'Username and Phone fields are required; Password needs to be provided'))
